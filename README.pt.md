...
| Plataforma      | Estado                                |
| --------------- | ------------------------------------- |
| Windows 10 | Disponível — v1.0.2 |
| Windows 11 | Disponível — v1.0.2 |
| macOS           | Planeado                              |
| Linux           | Planeado                              |
| Microsoft Store | Planeado                              |

O Vision Guard PC v1.0.2 está disponível para Windows 10 e Windows 11.
...
O Vision Guard PC v1.0.2 é distribuído como uma aplicação portátil para Windows. Não necessita de instalação.

1. Abra a [versão oficial mais recente](https://github.com/MauricioMoraisZage/vision-guard-pc/releases/latest).
2. Descarregue `VisionGuardPC-1.0.2-Windows-x64.exe`.
...
O Vision Guard PC v1.0.2 para Windows já está disponível através da página oficial do GitHub Releases.
